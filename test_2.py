...
from call_backs import early_stopping,reduce_lr
...
data_1_path = "/home/hanlinn/tensorflow_datasets/scarasm/Sarcasm_Headlines_Dataset_v2.json"
...
history = model.fit(train_dataset, 
                    ...
                    callbacks= [early_stopping(patience=3),reduce_lr(patience=1)],
                    verbose=1)
